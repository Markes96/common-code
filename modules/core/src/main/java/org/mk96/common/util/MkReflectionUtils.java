...
public class MkReflectionUtils {
  ...
  public Field findField(final Class<?> type, final String FieldName) {
    ...
    try {
      ...
      throw new MkException(
          "Field \"" + FieldName + "' not finded on class '" + type.getSimpleName() + "'", e);
    }
  ...
  public Object findFieldValue(final Object obj, final Field field) {
    ...
    try {
      ...
      throw new MkException(
          "Field '" + field.getName() + "' is not accesible on class '"
              + obj.getClass().getSimpleName() + "'",
          e);
    }
  ...
  public Method findMethod(final Class<?> type, final String methodName,
      final Class<?>... params) {

    try {
      return type.getDeclaredMethod(methodName, params);
    } catch (final NoSuchMethodException e) {
      final List<String> paramsString =
          Stream.of(params).map(param -> param.getSimpleName()).toList();
      throw new MkException(
  ...
  public Object invokeMethod(final Object obj, final String methodName,
  ...
  public Object invokeMethod(final Object obj, final Method method, final Object... params)
    ...
    try {
      ...
      final List<String> methodParamTypes =
          Stream.of(method.getParameterTypes()).map(Class::getCanonicalName).toList();

      final List<String> paramTypes =
          Stream.of(params).map(Object::getClass).map(Class::getSimpleName).toList();
