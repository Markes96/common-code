...
public class MkLoadFileUtilsTest {
  ...
  void getAbsolutePathTest() {
    ...
    final Path compleatPath =
        MkLoadFileUtils.getAbsolutePath("util/loadfile/getAbsolutePathExist.json");
  ...
  void loadTest() {
    ...
    final String filesString =
        MkLoadFileUtils.load(String.class, "util", "loadfile", "loadFileExample.json");
    Assertions.assertNotNull(filesString);

    final byte[] fileByteArray =
        MkLoadFileUtils.load(byte[].class, "util", "loadfile", "loadFileExample.json");
    Assertions.assertNotNull(fileByteArray);

    final FileObject fileObject =
        MkLoadFileUtils.load(FileObject.class, "util", "loadfile", "loadFileExample.json");
