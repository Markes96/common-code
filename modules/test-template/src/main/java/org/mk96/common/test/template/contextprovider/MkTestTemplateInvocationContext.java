...
public class MkTestTemplateInvocationContext implements TestTemplateInvocationContext {
  ...
  public String getDisplayName(final int invocationIndex) {
    ...
    final String displayPath =
        sourcePath + StringUtils.substringAfterLast(slashPath, sourcePath);
  ...
  public List<Extension> getAdditionalExtensions() {
    ...
    final MkTestTemplateParameterResolver parameterResolver =
        new MkTestTemplateParameterResolver(parameter);
