package com.mk96.common.test.template.annotation;
...
public @interface MkTestTemplateConfiguration {
  ...
  /**
   * <p>
   * {@link MkTestTemplateType} parameter used to define if load file mode is enabled. Default false
   * {@link MkTestTemplateType}.DEFAULT
   * </p>
   *
   * @return test type
   */
  MkTestTemplateType testType() default MkTestTemplateType.DEFAULT;
