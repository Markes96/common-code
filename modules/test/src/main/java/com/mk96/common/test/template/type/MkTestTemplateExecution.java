package com.mk96.common.test.template.type;
...
import com.mk96.common.type.MkObject;
...
public class MkTestTemplateExecution extends MkObject {
  ...
  public MkTestTemplateExecution(
      final MkTestTemplateParameter parameter,
      final MkTestTemplateConfiguration configuration) {

    this.parameter = parameter;

    if (Objects.nonNull(configuration)) {
      setTestType(configuration.testType());
    ...
    if (Objects.nonNull(subConfiguration)) {
      setTestType(subConfiguration.testType());
