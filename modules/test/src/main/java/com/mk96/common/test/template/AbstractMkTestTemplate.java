...
import com.mk96.common.test.template.component.MkTestTemplateComparator;
import com.mk96.common.test.template.component.MkTestTemplateFiltrator;
import com.mk96.common.test.template.component.MkTestTemplateInvocator;
import com.mk96.common.test.template.constant.MkTestTemplateConstant;
import com.mk96.common.test.template.contextprovider.MkTestTemplateInvocationContextProvider;
...
public abstract class AbstractMkTestTemplate extends AbstractMkTest {
  ...
  private void execute(final MkTestTemplateExecution execution)
    ...
    if (execution.getTest().getReturnType() != void.class) {
      final Object[] testResultArray =
          filtrator.filter(convertToArray(testResult), execution.getRegexForReplace());
