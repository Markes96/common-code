...
import com.mk96.common.constant.DateFormatConstant;
...
public class MkSerializeUtils {
  ...
  public <T> T read(final Class<T> type, final String value) {
    try {
      ...
      throw new MkException(
          "Could not deserialize " + value + " on " + type.getSimpleName() + " object", e);
    }
  }
  ...
  /**
   * Method used to serialize an object as {@link String} with default pretty printer
   *
  ...
  public String writeAsString(final Object obj) {
    try {
      ...
      throw new MkException(
          "Could not serialize " + obj.getClass().getSimpleName() + " on string", e);
    }
  }
  ...
  public String writeAsFlatString(final Object obj) {
    try {
      ...
      throw new MkException(
          "Could not serialize " + obj.getClass().getSimpleName() + " on flat string", e);
    }
  }
  ...
  public byte[] writeAsBytes(final Object obj) {
    try {
      ...
      throw new MkException(
          "Could not serialize " + obj.getClass().getSimpleName() + " on bytes", e);
    }
  }
  ...
  public byte[] writeAsFlatBytes(final Object obj) {
    try {
      ...
      throw new MkException(
          "Error: Could not serialize " + obj.getClass().getSimpleName() + " on flat bytes", e);
    }
  }
