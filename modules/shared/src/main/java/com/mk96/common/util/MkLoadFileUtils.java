...
import com.mk96.common.constant.CommonConstant;
...
public class MkLoadFileUtils {
  ...
  /**
   * Load file from relative {@link String} path on a {@link Byte} array, {@link String} or
   * {@link T} object
   *
   ...
   * @return File loaded on a {@link Byte} array, {@link String} or {@link T} object
   */
  ...
  /**
   * Load {@link Path} file on a {@link Byte} array, {@link String} or {@link T} object
   *
   * @param <T> deserialize type
   * @param type -> indicates return type
